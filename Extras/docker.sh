...
function create_container() {
    ...
    case ${OS_CHOICE:-1} in
      1) IMAGE="happy-node/ubuntu:22" ; DEFAULT_HOST="ubuntu22" ;;
      2) IMAGE="happy-node/ubuntu:24" ; DEFAULT_HOST="ubuntu24" ;;
      3) IMAGE="happy-node/debian:11" ; DEFAULT_HOST="debian11" ;;
      4) IMAGE="happy-node/debian:12" ; DEFAULT_HOST="debian12" ;;
      5) IMAGE="happy-node/debian:13" ; DEFAULT_HOST="debian13" ;;
      *) IMAGE="happy-node/debian:12" ; DEFAULT_HOST="debian12" ;;
    esac
