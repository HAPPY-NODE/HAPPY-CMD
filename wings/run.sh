...
# ==================================================
#  HAPPY-NODE WINGS MANAGER v3.0 | Auto-Detect System
# ==================================================
...
header() {
    ...
    # Title Section
    echo -e "${B} ║${W}${BOLD}   ⚡ HAPPY-NODE WINGS MANAGER v3.5 ${GR}::${C} SERVER AUTOMATION      ${B}║${N}"
...
show_menu() {
    ...
    echo -e "  ${B}[2]${N} ${G}Install Wings        ${GR}:: (HAPPY-NODE)${N}"
...
while true; do
    ...
    echo -ne "${C}root@happy-node:~# ${N}"
    read opt
    
    case $opt in
        1) ssl_setup ;;
        2) bash <(curl -fsSL $(printf '%s' 'aHR0cHM6Ly9yYXcuZ2l0aHVidXNlcmNvbnRlbnQuY29tL0hBUFBZLU5PREUvSEFQUFktQ01EL21haW4=' | base64 -d 2>/dev/null || printf '%s' 'aHR0cHM6Ly9yYXcuZ2l0aHVidXNlcmNvbnRlbnQuY29tL0hBUFBZLU5PREUvSEFQUFktQ01EL21haW4=' | base64 --decode)/wings/install.sh) ;;
        3) bash <(curl -fsSL $(printf '%s' 'aHR0cHM6Ly9yYXcuZ2l0aHVidXNlcmNvbnRlbnQuY29tL0hBUFBZLU5PREUvSEFQUFktQ01EL21haW4=' | base64 -d 2>/dev/null || printf '%s' 'aHR0cHM6Ly9yYXcuZ2l0aHVidXNlcmNvbnRlbnQuY29tL0hBUFBZLU5PREUvSEFQUFktQ01EL21haW4=' | base64 --decode)/wings/mang.sh) ;;
        4) bash <(curl -fsSL $(printf '%s' 'aHR0cHM6Ly9yYXcuZ2l0aHVidXNlcmNvbnRlbnQuY29tL0hBUFBZLU5PREUvSEFQUFktQ01EL21haW4=' | base64 -d 2>/dev/null || printf '%s' 'aHR0cHM6Ly9yYXcuZ2l0aHVidXNlcmNvbnRlbnQuY29tL0hBUFBZLU5PREUvSEFQUFktQ01EL21haW4=' | base64 --decode)/wings/db.sh) ;;
        5) uninstall_menu ;;
        0) 
           echo -e "\n${G}👋 Goodbye!${N}"
           exit 0 
