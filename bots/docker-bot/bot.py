...
async def about(interaction: discord.Interaction):
    ...
    embed.add_field(
        name="👨‍💻 Meet the Developer • HAPPY-NODE",
        value=(
            "**HAPPY-NODE** is a passionate **Full-Stack Developer** and **DevOps Enthusiast** 🇮🇳\n\n"
            "🔹 **Specialties:**\n"
    ...
    # Social Links
    embed.add_field(
        name="🔗 Connect with HAPPY-NODE",
        value=(
            "💻 **GitHub:** [View Projects & Scripts](https://github.com/HAPPY-NODE)\n"
            "🌐 **Website:** [HAPPY NODE Toolkit](https://github.com/HAPPY-NODE/HAPPY-CMD)"
        ),
        inline=False
    )
    ...
    embed.add_field(
        name="🎮 Fun Fact",
        value=(
            "HAPPY-NODE is also a big **Minecraft** fan! Many tutorials cover free/paid hosting, "
    ...
    embed.set_footer(
        text="Built with ❤️ and ☕ by HAPPY-NODE | Thank you for using VPS Manager Bot!",
